...
\begin{center}\includegraphics[width=0.6\linewidth]{../../figures/response} \end{center}
...
\begin{center}\includegraphics[width=0.8\linewidth]{../../figures/eurostat_page} \end{center}
...
\begin{center}\includegraphics[width=0.8\linewidth]{../../figures/apistring1} \end{center}
...
```
## Table nama_10_gdp cached at C:\Users\solvebjo\AppData\Local\Temp\RtmpqUYqH2/eurostat/nama_10_gdp_date_code_FF.rds
```
