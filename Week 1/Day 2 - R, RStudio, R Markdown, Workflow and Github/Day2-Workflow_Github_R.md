---
title: "R, RStudio, R Markdown, Workflow and Github"
subtitle: "Day 2"
...
\begin{center}\includegraphics[width=0.8\linewidth]{../../figures/RStudio_overview} \end{center}
...
\begin{center}\includegraphics[width=0.8\linewidth]{../../figures/rstudio_1} \end{center}
...
\begin{center}\includegraphics[width=0.8\linewidth]{../../figures/rstudio_2} \end{center}
...
\begin{center}\includegraphics[width=0.8\linewidth]{../../figures/rstudio_3} \end{center}
...
\begin{center}\includegraphics[width=0.8\linewidth]{../../figures/rstudio_4} \end{center}

To save the script, hit the blue disc-symbol as shown in the picture below.



\begin{center}\includegraphics[width=0.8\linewidth]{../../figures/rstudio_5} \end{center}
...
\begin{center}\includegraphics[width=0.8\linewidth]{../../figures/objects} \end{center}
...
\begin{center}\includegraphics[width=0.8\linewidth]{../../figures/packages} \end{center}
...
\begin{center}\includegraphics[width=0.8\linewidth]{../../figures/rmarkdown_2} \end{center}
...
\begin{center}\includegraphics[width=1\linewidth]{../../figures/rmarkdown-cheatsheet} \end{center}
...
\begin{center}\includegraphics[width=1\linewidth]{../../figures/rfolders} \end{center}
...
\begin{center}\includegraphics[width=0.8\linewidth]{../../figures/git1} \end{center}


\begin{center}\includegraphics[width=0.8\linewidth]{../../figures/git2} \end{center}


\begin{center}\includegraphics[width=0.8\linewidth]{../../figures/git3} \end{center}
...
\begin{center}\includegraphics[width=0.8\linewidth]{../../figures/project1} \end{center}

2. Choose "Version Control".


\begin{center}\includegraphics[width=0.8\linewidth]{../../figures/project2} \end{center}

3. Choose "Git".


\begin{center}\includegraphics[width=0.8\linewidth]{../../figures/project3} \end{center}
...
\begin{center}\includegraphics[width=0.8\linewidth]{../../figures/project4} \end{center}



\begin{center}\includegraphics[width=0.8\linewidth]{../../figures/project5} \end{center}
...
\begin{center}\includegraphics[width=0.8\linewidth]{../../figures/project6} \end{center}
