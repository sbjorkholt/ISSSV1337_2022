...
![.](./scripts/figures/datascience_figure.png){width=20%}
...
Here is a table that details more specifically what we will cover in each week (a more comprehensive table is in the [README](https://github.com/sbjorkholt/ISSSV1337)):
...
Agile work involves (1) breaking a task up into smaller parts, (2) work on each part in several phases, (3) review the process and learn from feedback, and (4) doing it all over again.
